...
function Navbar() {
    ...
    return (
        <div className={`flex justify-center items-center w-full h-auto`}>
            <nav
                className={`fixed sm:top-0 sm:h-fit sm:rounded-full rounded-t-3xl sm:p-2 p-3 sm:mx-auto bottom-0 ${isScrolled ? 'sm:w-full sm:rounded-none sm:my-0 sm:justify-evenly sm:py-3' : 'sm:w-fit sm:my-8'} bg-indigo-400 text-white shadow-lg flex transition-all duration-300 ease-in-out justify-around space-x-2`}>
                {/* Botón de Inicio */}
                <button
